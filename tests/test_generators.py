...
def sample_transactions() -> List[Dict[str, Any]]:
    return [
        ...
        {"id": 142264268, "operationAmount": {"currency": {"code": "EUR"}}, "description": "Перевод со счета на счет"},
        {"id": 873106923, "operationAmount": {"currency": {"code": "USD"}}, "description": "Перевод с карты на карту"},
    ]
