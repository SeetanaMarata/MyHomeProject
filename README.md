...
Тестирование: полное покрытие тестами всех сценариев использования
...
Теперь проект поддерживает чтение финансовых операций не только из JSON, но и из CSV/Excel файлов.
...
**Возвращает:**
- Список словарей с транзакциями (ключи - названия колонок)
...
###  Требования
Для работы с новыми форматами требуется:
```
